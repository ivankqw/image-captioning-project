...
from metrics import (calculate_bleu_score, calculate_cider_score,
                     calculate_meteor_score, evaluate)
...
def main():
    ...
    train_images, val_images, test_images = get_splits(image_names, test_size=0.3)
    ...
    for epoch in range(num_epochs):
        ...
        scheduler.step()
    os.makedirs("models/base_model", exist_ok=True)
    torch.save(encoder.state_dict(), "models/base_model/encoder.pth")
    torch.save(decoder.state_dict(), "models/base_model/decoder.pth")
