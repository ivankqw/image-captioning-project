...
from models.transfer_learning_model.model import DecoderRNN, EncoderCNN
...
def main():
    ...
    parser.add_argument(
        "--model_dir",
        type=str,
        default="models/transfer_learning_model",
    ...
    test_image2captions = prepare_image2captions(
        test_images, captions_seqs, idx2word
    )
